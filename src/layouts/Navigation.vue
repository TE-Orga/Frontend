         ...
         <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
               <div class="flex items-center ms-3">
                  <!-- notification icon -->
                  <button type="button" class="mr-4 flex text-sm bg-gray-100 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                     ...
                     <svg class="w-6 h-6 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 2a6 6 0 00-6 6v4H3a1 1 0 000 2h14a1 1 0 000-2h-1V8a6 6 0 00-6-6zM8 18a2 2 0 104 0H8z"></path>
                     </svg>
                  </button>
                  <!-- bouton mobile open -->
                  <div>
